        ...
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              >
                <div className="flex flex-col sm:flex-row items-center gap-6 p-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-lg text-primary mb-2 truncate">{cartItem.name}</h3>
          ...
          <div className="w-full lg:w-80 lg:sticky lg:top-24">
            <div className="card p-6">
              <h2 className="font-bold text-2xl text-primary mb-6">Basket Summary</h2>
              <div className="space-y-4 mb-6">
                ...
                <div className="border-t border-accent pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-xl font-semibold text-primary">Grand Total:</span>
